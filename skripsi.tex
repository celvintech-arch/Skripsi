...
\lstdefinelanguage{myLang}
{
  ...
  morecomment=[l]{\#}, % l is for line comment (\# escapes the hash for LaTeX)
...
% \input{Header/sampul}
\input{Header/cover-proposal}
\newpage
\input{Header/persetujuan-proposal-skripsi}
\input{Header/persetujuan-skripsi}
\input{Header/pengesahan}
\input{Header/pernyataan}

\input{Header/abstrak}
% \input{Header/abstract}
\input{Header/kata-pengantar}
% \input{Header/abstract}
\input{Header/daftar-isi}
\input{Header/daftar-tabel}
\input{Header/daftar-gambar}
% \input{Header/daftar-kode}

\input{Isi/bab1_pendahuluan}
\input{Isi/bab2_dasar-teoritik-metodologi-perancangan.tex}
\input{Isi/bab3_pembuatan-dan-implementasi}
\input{Isi/bab4_hasil-dan-pembahasan}
\input{Isi/bab5_kesimpulan-dan-saran}
...
\input{Isi/lampiran}
\input{Footer/daftar-bimbingan}

\input{Footer/lampiran-nashkah-publikasi}
\input{Footer/riwayat-hidup}
% \input{Footer/manual-program}
\end{document}